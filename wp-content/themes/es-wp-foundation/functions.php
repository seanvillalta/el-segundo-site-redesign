...
function register_my_styles(){
  wp_register_style('foundation', get_template_directory_uri()."/assets/dest/css/bundle.min.css",array(),'5.1.1','screen');
...
function register_my_scripts() {
  wp_register_script('jquery', "/assets/dest/js/vendors/vendors.min.js", array(),'2.1.0',false);
